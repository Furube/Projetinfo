...
/**************************************************************
    ...
    ou bien     for (auto &e : m_edaages) ...e.second...
...
class Vertex
{
    ...
    private :
        ...
        ///coordonnée en y
        int coordy;
        ///nom de l'image du sommet
        std::string nom_pic;

        int m_but=0;
        ///capacité de portage de la population
        float Kmange=0.01;
        ///coefficient prédateur
        float Kmangeur=0.01;
    ...
    public:
        ...
        int get_but(){ return m_but;}
        int get_indice(){return m_indice;}
...
class GraphInterface
{
    ...
    private :
        ...
        /// Dans cette boite seront ajoutés des boutons de contrôle, les text et les fonds
        grman::WidgetBox m_tool_box;
        grman::WidgetButton bouton1;
        grman::WidgetText bouton1_label;
        grman::WidgetButton bouton2;
        grman::WidgetText bouton2_label;
        grman::WidgetButton bouton3;
        grman::WidgetText bouton3_label;
        grman::WidgetImage banquise;
        grman::WidgetImage foret;
        grman::WidgetImage savane;
...
class Graph
{
    ...
    public:
        ...
        ///Méthode remplissage
        void make_example();
        ///Méthode chargement de fichier
        void chargement_fic(std::string ficbanq, std::string ficarete1);
        ///Méthode suppression
        void supprimer_sommet(int indice);
        ///Méthode suppression d'arrête
        void test_remove_edge(int eidx);
        ///Méthode suppression de sommet
        void test_remove_Vertex(int indice);
        ///Méthode d'ajout
        void ajout();
        ///Méthode de la simulation au cours du temps
        void Dynamique();

        void Matrice_Adj() ;
        int *CFC(int ** adjacence , int som, int ordre);
        int **toutes_CFC(int ** adjacence, int ordre) ;

        /// La méthode update à appeler dans la boucle de jeu pour les graphes avec interface
        void update();

        /// methode de la sauvegarde
        void sauver_banquise();
        void sauver_foret();
        void sauver_savane();

        void appel_graphe_banquise_base();
        void appel_graphe_foret_base();
        void appel_graphe_savane_base();

        void appel_graphe_banquise_sauv();
        void appel_graphe_foret_sauv();
        void appel_graphe_savane_sauv();
