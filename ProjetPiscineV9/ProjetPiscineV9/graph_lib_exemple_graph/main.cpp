...
int main()
{
    ...
    do
    {
        ...
        grman::show_picture(screen,"menu.bmp",0,0);
        ...
        case '1' :
        {
            do
            {
                ...
                case '1' :
                {
                    ...
                    {
                        g1.appel_graphe_banquise_base();
                    }
                    else if (Choix_sauv == '2') ///on ouvre le fichier sauvergardé
                    {
                        g1.appel_graphe_banquise_sauv();
                    }
                ...
                case '2' :
                {
                    ...
                    if (Choix_sauv == '1') /// on ouvre le fichier de base
                    {
                        g2.appel_graphe_foret_base();
                    }
                    else if (Choix_sauv == '2') ///on ouvre le fichier sauvergardé
                    {
                        g2.appel_graphe_foret_sauv();
                    }
                ...
                case '3' :
                {
                    ...
                    if (Choix_sauv == '1') /// on ouvre le fichier de base
                    {
                        g3.appel_graphe_savane_base();
                    }
                    else if (Choix_sauv == '2') ///on ouvre le fichier sauvergardé
                    {
                        g3.appel_graphe_savane_sauv();
                    }
