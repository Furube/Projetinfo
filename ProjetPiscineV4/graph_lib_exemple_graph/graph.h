...
class Graph
{
    ...
    public:
        ...
        void make_example();
        void chargement_fic_banquise();
        void chargement_fic_foret();
        void chargement_fic_savane();
        void ajout();
        ...
        void appel_graphe_banquise();
        void appel_graphe_foret();
        void appel_graphe_savane();
