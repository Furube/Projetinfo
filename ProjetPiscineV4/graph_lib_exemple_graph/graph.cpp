...
void Graph::chargement_fic_banquise()
{
    std::ifstream fic("ficbanquise_base.txt");
    std::ifstream fic1("ficarete1_base.txt");
    double val=0.0;
    int x=0;
    int y=0;
    std::string nom;
...
void Graph::chargement_fic_foret()
{
    std::ifstream fic("ficforet_base.txt");
    std::ifstream fic1("ficarete2_base.txt");
    double val=0.0;
    int x=0;
    int y=0;
    std::string nom;
...
void Graph::chargement_fic_savane()
{
    std::ifstream fic("ficsavane_base.txt");
    std::ifstream fic1("ficarete3_base.txt");
    double val=0.0;
    int x=0;
    int y=0;
    std::string nom;
...
{
    std::ofstream fichier_sauv_som("fic_banquise_sauv.txt" ,  std::ios::out | std::ios::trunc) ; /// lecture du fichier et écrire à la fin du fichier texte en écrasant ce qui a été fait dans ce fichier précédemment
...
void Graph::appel_graphe_savane()
{
