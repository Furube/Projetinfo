...
{
    std::ofstream fichier_sauv_matrice(fichier_matrice,  std::ios::out | std::ios::trunc) ;
    if (fichier_sauv_matrice)
    {
        ...
        std::cout << " " ;
        fichier_sauv_matrice<<" ";
        for(int i=0; i<m_ordre; i++)
        {
            std::cout << " " << i  ;
            fichier_sauv_matrice << " " << i ;
        }
        std::cout << "\n\n" ;
        fichier_sauv_matrice << "\n" ;
        ...
        for(int i=0; i<m_ordre; i++)
        {
            ...
            for(int j=0; j<m_ordre; j++)
            {
                ...
                adjacence[i][j]=0 ;
                //fichier_sauv_matrice << adjacence[i][j] ;
                std::map <int, Edge>::iterator it ;
                for (it=m_edges.begin() ; it!=m_edges.end(); it++)
                {
                ...
                /*
                 ...
                 for (it=m_vertices.begin(); it!=m_vertices.end(); it ++)
                 {
                     ...
                     for(int k=0; k<it->second.m_out.size(); k++)
                     {

                         adjacence[i][it->second.m_out[k]]=1;

                         if (it->second.m_out[k]==j)
                         {
                             adjacence[i][j]=1;
                         }
                     }
                 ...
                 {
                     adjacence[it2->second.m_from][it2->second.m_to]=1;
                 }*/
                std::cout << adjacence[i][j] << " " ;
                fichier_sauv_matrice << adjacence[i][j] << " " ;
